...
const ComparisonIcon = (props: SVGIconProps) => {
  return (
    <SVGIcon {...props}>
      <defs>
        <linearGradient
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <g fillRule="nonzero" transform="translate(1 4)">
          <use fill="url(#ComparisonIcon_a)" xlinkHref="#ComparisonIcon_b" />
          <use
            fill="#000"
            filter="url(#ComparisonIcon_c)"
            xlinkHref="#ComparisonIcon_b"
          />
        </g>
        <g transform="translate(1 4)">
          <use fill="url(#ComparisonIcon_d)" xlinkHref="#ComparisonIcon_e" />
          <use
            fill="#000"
            filter="url(#ComparisonIcon_f)"
            xlinkHref="#ComparisonIcon_e"
          />
        </g>
      </g>
    </SVGIcon>
